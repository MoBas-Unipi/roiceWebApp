    ...
    <head>
        ...
        <script src="/dashboard/html/js/createAuction.js"></script>
    </head>
    ...
    <div id="main-wrapper">
        ...
        <div class="all-container">
            ...
            <div class="container">
                ...
                <form method="post" action="/phoneDetails/createAuction?phoneName=${phone.name}" id="createAuctionForm" onsubmit="return validateForm()">
