...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/dashboard/assets/images/RoiceIcon.png">
    <!-- Bootstrap Core CSS -->
...
<section id="wrapper" class="error-page">
    <div class="error-box">
        <div class="error-body text-center">
            ...
            <a href="/homePage" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
    </div>
</section>
<!-- ============================================================== -->
<!-- End Wrapper -->
